...
<!--
  ...
  "Explore our capabilities": 4 cards in a row, each card is a
  link (<a>) when Card{N}CtaHref is set, with a "Learn more"
  chip from Card{N}CtaLabel. Navy section, 1140px content rail
  (SectionMaxWidth overrides).
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <section>
      <xsl:attribute name="class">rbccm-capability-cards rbccm-capability-cards--4</xsl:attribute>
