...
<xsl:stylesheet version="1.0" xmlns:xsl=http://www.w3.org/1999/XSL/Transform>
  ...
  <xsl:template match="/">
    ...
    <div class="insights-stories initial">
      <div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                      ...
                      <div>
                        ...
                        <div class="img-stretch inline">
                          ...
                          <!-- <xsl:if test="$ARTICLE_TYPE = 'video' and /Properties/Datum[@ID='ShowPlayButton'] = 'true'">
                            <div class="play-overlay-sm">
            ...
            <a data-bind="visible: link != '', attr:{{href: link}}">
              <div data-bind="css: {{ 'tile--white' : ($index() >= 0) }}">
                ...
                <div data-bind="visible: $index() &gt;= 0">
                    ...
                    <!-- <div class="play-overlay-sm" data-bind="visible: type === 'video'">
                      <em class="fa fa-play">&nbsp;</em>
                    </div> -->
                    <div class="tile-overlay"></div>
                  </div></div>
                  ...
                  <div class="white-box-text">
                    ...
                    <div class="external-button-group">
                      ...
                      <a class="learn-more audio-play btn-close-player" href="javascript:void(0);" data-bind="visible: podcast !== ''" aria-label="Play episode"><u>Play episode</u></a>
                          ...
                          <!-- ADD PODCAST IFRAME -->
                        <!-- <p class="read-watch" style="padding-top: 30px;">
                           <img src=https://www.rbccm.com/assets/rbccm/images/campaign/podcast-sm-bl.svg alt="Listen Time" data-bind="visible: podcast != ''"/><span class="date" data-bind="visible: podcast != '',html: watchtime"></span>
                           <span class="separator" role="presentation" style="display: inline-block;height: 15px;border-left: 1px #000000 solid;opacity: .5;margin: 0 7px;" data-bind="visible: podcast != ''"></span>
                            <img src=https://www.rbccm.com/assets/rbccm/images/gib/icons/read-icon-bl.svg alt="ReadTime"/><span class="date" data-bind="html: readtime"></span>
                          </p> -->
                          <p class="read-watch" style="padding-top: 30px;">
...
$(document).ready(function () {
  ...
  $(document).on("click", ".audio-play", function () {
    ...
    // Only show the clicked podcast player if it's hidden
    if (!podcastElement.is(":visible")) {
      podcastElement.show();
      iframe.attr("src", iframe.data("src"));  // Restore the iframe src if visible
    }
  });
  ...
  $(document).on("click", ".close-btn", function () {
    ...
    // Hide the podcast player and clear the iframe's src to stop audio
    podcastElement.hide();
    iframe.data("src", iframe.attr("src")); // Store the src before resetting it
    iframe.attr("src", "");  // Remove the iframe src to stop audio
  });
