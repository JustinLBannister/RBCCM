...
(function () {
  ...
  function bindRow(row) {
    ...
    var controls  = row.parentNode.querySelector('.rbccm-story-tiles__controls');
    if (!controls) return;

    var seeMore   = controls.querySelector('.rbccm-story-tiles__see-more');
    var viewAll   = controls.querySelector('.rbccm-story-tiles__view-all');
    if (!seeMore) return;
  ...
  function init() {
    var rows = document.querySelectorAll('.rbccm-story-tiles__row[data-load-more]');
