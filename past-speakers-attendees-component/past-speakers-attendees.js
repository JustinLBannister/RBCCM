/* =========================================
   RBC CM — Past Speakers & Attendees
   Mirrors upcoming-conferences slick pattern:
...
(function () {
  ...
  $(function () {
    var $section = $('#rbccm-past-speakers-attendees');
    if (!$section.length) return;

    var $track    = $section.find('#rbccm-past-speakers-attendees-cards');
    var $dots     = $section.find('#rbccm-psa-dots');
    var $prev     = $section.find('#rbccm-psa-prev');
    var $next     = $section.find('#rbccm-psa-next');
    ...
    function syncArrows() {
      ...
      var cardWidth    = $track.find('.rbccm-past-speakers-attendees__card').first().outerWidth(true);
    ...
    var rTimer;
    $(window).on('resize.rbccmPastSpeakers', function () {
      clearTimeout(rTimer);
