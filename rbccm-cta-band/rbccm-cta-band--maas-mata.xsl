...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <!--
    Skin: CTA Band :: maas-mata (single-skin build)

    MAAS+MATA "Talk with an expert."
    Big serif heading + yellow highlight + 1 yellow pill CTA. Own
    navy gradient, or transparent (BgTransparent = yes) inside the
    MAAS+MATA dark-strip wrapper.
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="PRESET" select="'maas-mata'"/>
