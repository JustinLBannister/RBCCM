...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <!--
    Skin: CTA Band :: strategy-and-economics (single-skin build)

    Strategy and Economics "Log in to RBC insights"
    Small serif heading + body (wrapped in .__intro) + 2 buttons:
    primary yellow + secondary outlined.
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="PRESET" select="'strategy-and-economics'"/>
