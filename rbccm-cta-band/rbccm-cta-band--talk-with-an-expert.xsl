...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="EYEBROW_TEXT"  select="normalize-space(/Properties/Data/Datum[@ID='EyebrowText']/text()[last()])"/>
    <xsl:variable name="EYEBROW_TAG_R" select="normalize-space(/Properties/Data/Datum[@ID='EyebrowTag']/text()[last()])"/>
