...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <!-- Skin: RBC CM How We Think
       ...
       Deploy alongside this skin:
         /assets/rbccm/css/sub/test/how-we-think.css
         /assets/rbccm/js/sub/test/how-we-think.js
       =================================================================== -->
  ...
  <xsl:template match="/">
    ...
    <!-- ═══════════════════════════════════════════════════════════
         MARKUP
         =================================================================== -->
    <link rel="stylesheet" href="/assets/rbccm/css/sub/test/how-we-think.css"/>
    ...
    <!-- ═══ EXTERNAL JS ═══ -->
    <script src="/assets/rbccm/js/sub/test/how-we-think.js"></script>
    <script src="/assets/rbccm/js/sub/test/how-we-think-feeds.js"></script>
