...
<!-- MAAS + MATA Landing Page
     ============================================================
     Single-component skin for the MAAS + MATA landing page.
     Consumes maas-mata-properties.xml.

     Deploy alongside the skin:
       /assets/rbccm/css/components/maas-mata.css  (extracted from
                                                    the source
                                                    maas-mata.html
                                                    <style> block)
       /assets/rbccm/js/components/maas-mata.js    (extracted from
                                                    the source
                                                    maas-mata.html
                                                    <script> block —
                                                    animate binding +
     ...
     Optional runtime dependencies (loaded on the page shell, not
     scoped to this component):
       animate.css@4.1.1  (CDN)
       Brightcove player  (per-instance, only when
                            ChartBrightcoveVideoId is set)
       Marketo forms      (per-instance, only when
                            NewsletterMarketoFormId is set)

     Rendering Mode: XSLT 1.0 (matches every other RBCCM skin).
     No 2.0-only functions used.
     ============================================================ -->
    ...
    <div class="rbccm-maas-mata" id="rbccm-mm-page">
      ...
      <section class="rbccm-maas-mata__hero" aria-label="Hero">
        <div class="rbccm-maas-mata__container">
          <h1 class="rbccm-maas-mata__hero-eyebrow" data-animate-hero="fadeInDown" data-animate-delay="0">
            <xsl:value-of select="$HERO_EYEBROW" />
          </h1>
          <p class="rbccm-maas-mata__hero-title" data-animate-hero="fadeInUp" data-animate-delay="150">
            <span class="rbccm-maas-mata__hero-title-line"><xsl:value-of select="$HERO_TITLE_1" /></span>
            <span class="rbccm-maas-mata__hero-title-line"><xsl:value-of select="$HERO_TITLE_2" /></span>
          </p>
          <p class="rbccm-maas-mata__hero-subtitle" data-animate-hero="fadeInUp" data-animate-delay="300">
          ...
          <div class="rbccm-maas-mata__hero-actions" data-animate-hero="fadeInUp" data-animate-delay="450">
            <a class="rbccm-maas-mata__btn rbccm-maas-mata__btn--blue">
              <xsl:attribute name="href"><xsl:value-of select="$HERO_CTA_HREF" /></xsl:attribute>
              <span><xsl:value-of select="$HERO_CTA_LABEL" /></span>
      ...
      <div class="rbccm-maas-mata__dark-strip">
        ...
        <section class="rbccm-maas-mata__new-standard" aria-label="A new standard for multi-asset trading">
          <div class="rbccm-maas-mata__container">
            <h2 class="rbccm-maas-mata__new-standard-heading" data-animate="fadeInUp">
              <span class="rbccm-maas-mata__new-standard-heading-lead"><xsl:value-of select="$NS_LEAD" /></span>
              <span class="rbccm-maas-mata__new-standard-heading-highlight"><xsl:value-of select="$NS_HIGHLIGHT" /></span>
              <span class="rbccm-maas-mata__new-standard-heading-accent"><xsl:value-of select="$NS_ACCENT" /></span>
            </h2>
            <div class="rbccm-maas-mata__new-standard-body" data-animate="fadeInUp" data-animate-delay="150">
            ...
            <a class="rbccm-maas-mata__btn rbccm-maas-mata__btn--yellow" data-animate="fadeInUp" data-animate-delay="300">
              <xsl:attribute name="href"><xsl:value-of select="$NS_CTA_HREF" /></xsl:attribute>
              <span><xsl:value-of select="$NS_CTA_LABEL" /></span>
            </a>
          </div>
        </section>
        ...
        <section class="rbccm-maas-mata__awards" aria-label="Awards">
          <h5 class="rbccm-maas-mata__awards-eyebrow" data-animate="fadeInUp">
            <xsl:value-of select="$AWD_EYEBROW" />
          </h5>

          <div class="rbccm-maas-mata__awards-track" data-awards-track="">
        ...
        <section class="rbccm-maas-mata__platforms" id="platform" aria-label="Two platforms, one unified ecosystem">
          <div class="rbccm-maas-mata__container">
            <h5 class="rbccm-maas-mata__platforms-eyebrow" data-animate="fadeInUp"><xsl:value-of select="$PLATFORMS_EYEBROW" /></h5>
            <h2 class="rbccm-maas-mata__platforms-heading" data-animate="fadeInUp" data-animate-delay="100"><xsl:value-of select="$PLATFORMS_HEADING" /></h2>

            <div class="rbccm-maas-mata__platforms-grid">
      ...
      <section class="rbccm-maas-mata__innovation-era" aria-label="Innovation for the next execution era">
        <div class="rbccm-maas-mata__container">
          <div class="rbccm-maas-mata__innovation-era-header" data-animate="fadeInUp">
            <h2 class="rbccm-maas-mata__innovation-era-heading"><xsl:value-of select="$INV_HEADING" /></h2>
            <p class="rbccm-maas-mata__innovation-era-body"><xsl:value-of select="$INV_BODY" disable-output-escaping="yes" /></p>
          </div>

          <ol class="rbccm-maas-mata__innovation-era-list">
      ...
      <div class="rbccm-maas-mata__deep-band">
        ...
        <section class="rbccm-maas-mata__mata-cap" aria-label="MATA Capabilities">
          <h5 class="rbccm-maas-mata__mata-cap-eyebrow" data-animate="fadeInUp"><xsl:value-of select="$MC_EYEBROW" /></h5>
          <div class="rbccm-maas-mata__mata-cap-header" data-animate="fadeInUp" data-animate-delay="100">
            <h2 class="rbccm-maas-mata__mata-cap-heading"><xsl:value-of select="$MC_HEADING" /></h2>
            <p class="rbccm-maas-mata__mata-cap-sub"><xsl:value-of select="$MC_SUBHEADING" disable-output-escaping="yes" /></p>
          </div>

          <div class="rbccm-maas-mata__mata-cap-grid">
        ...
        <section class="rbccm-maas-mata__market-insights">
          <div class="rbccm-maas-mata__container">
            <h5 class="rbccm-maas-mata__market-insights-eyebrow" data-animate="fadeInUp"><xsl:value-of select="$MK_EYEBROW" /></h5>
            <h2 class="rbccm-maas-mata__market-insights-heading" data-animate="fadeInUp" data-animate-delay="100"><xsl:value-of select="$MK_HEADING" /></h2>

            <div class="rbccm-maas-mata__featured-track" data-animate="fadeInUp" data-animate-delay="200" data-insights-track="">
        ...
        <section class="rbccm-maas-mata__demo" id="demo" aria-label="See the platform">
          <div class="rbccm-maas-mata__container">
            <h5 class="rbccm-maas-mata__demo-eyebrow" data-animate="fadeInUp"><xsl:value-of select="$DEMO_EYEBROW" /></h5>
            <h2 class="rbccm-maas-mata__demo-heading" data-animate="fadeInUp" data-animate-delay="100">
              <span><xsl:value-of select="$DEMO_PREFIX" /></span><span class="rbccm-maas-mata__demo-heading-highlight"><xsl:value-of select="$DEMO_HIGHLIGHT" /></span>.
            </h2>
            <p class="rbccm-maas-mata__demo-body" data-animate="fadeInUp" data-animate-delay="200"><xsl:value-of select="$DEMO_BODY" disable-output-escaping="yes" /></p>
            <a class="rbccm-maas-mata__btn rbccm-maas-mata__btn--yellow" data-animate="fadeInUp" data-animate-delay="300">
              <xsl:attribute name="href"><xsl:value-of select="$DEMO_CTA_HREF" /></xsl:attribute>
              <span><xsl:value-of select="$DEMO_CTA_LABEL" /></span>
              <svg class="rbccm-maas-mata__btn-icon" xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none" aria-hidden="true" focusable="false">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.4375 11.4999C1.4375 11.3093 1.51323 11.1265 1.64802 10.9917C1.78281 10.8569 1.96563 10.7812 2.15625 10.7812H19.1087L14.5849 6.25881C14.4499 6.12384 14.3741 5.9408 14.3741 5.74993C14.3741 5.55907 14.4499 5.37602 14.5849 5.24106C14.7198 5.10609 14.9029 5.03027 15.0938 5.03027C15.2846 5.03027 15.4677 5.10609 15.6026 5.24106L21.3526 10.9911C21.4196 11.0578 21.4727 11.1371 21.5089 11.2245C21.5451 11.3118 21.5638 11.4054 21.5638 11.4999C21.5638 11.5945 21.5451 11.6881 21.5089 11.7754C21.4727 11.8627 21.4196 11.942 21.3526 12.0088L15.6026 17.7588C15.4677 17.8938 15.2846 17.9696 15.0938 17.9696C14.9029 17.9696 14.7198 17.8938 14.5849 17.7588C14.4499 17.6238 14.3741 17.4408 14.3741 17.2499C14.3741 17.0591 14.4499 16.876 14.5849 16.7411L19.1087 12.2187H2.15625C1.96563 12.2187 1.78281 12.143 1.64802 12.0082C1.51323 11.8734 1.4375 11.6906 1.4375 11.4999Z" fill="currentColor"/>
              </svg>
            </a>
      ...
      <section class="rbccm-maas-mata__newsletter" aria-label="Stay informed">
        <div class="rbccm-maas-mata__container">
          <h2 class="rbccm-maas-mata__newsletter-heading"><xsl:value-of select="$NL_HEADING" /></h2>
          <p class="rbccm-maas-mata__newsletter-body"><xsl:value-of select="$NL_BODY" disable-output-escaping="yes" /></p>

          <form class="rbccm-maas-mata__newsletter-form" method="post">
            ...
            <div class="rbccm-maas-mata__newsletter-fields">
            ...
            <button type="submit" class="rbccm-maas-mata__newsletter-submit">
              <span class="rbccm-maas-mata__newsletter-submit-label"><xsl:value-of select="$NL_SUBMIT_LABEL" /></span>
